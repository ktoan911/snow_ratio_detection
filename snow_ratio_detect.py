...
def predict_one(
    ...
    mask = (prob > THRESHOLD).squeeze(0).squeeze(0)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ref", type=str, required=True, help="Reference (no-snow) image path"
    )
    parser.add_argument(
        "--cur", type=str, required=True, help="Current image path (may contain snow)"
    )
    parser.add_argument(
        "--out_dir",
        type=str,
